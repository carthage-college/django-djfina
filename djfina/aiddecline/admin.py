...
#within this app, aiddecline, as well as settings to change how
#we view entries within 'aiddecline'

#'admin' - necessary to change view settings when viewing an 'aiddecline' object
#'messages' - necessary to change success/fail messages when performing an action to an 'aiddecline' object
from django.contrib import admin
from djfina.aiddecline.models import AidDeclineModel, ProxyAidDecline
